...
<main>
	...
	{#each data.seasons as season}
		<section class="card"><div><h3>{season.year} — {season.name}</h3><span class="status">{season.status}</span><a href="/qualifications/{season.id}">Open qualifications</a><a href="/reports/season/{season.id}">Open statewide reports</a></div>
